...
const CreateBookingVenuePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${API_URL}/booking-venues`, formData, {
      ...
      <div className="container mx-auto px-4 sm:px-6 py-6 sm:py-12 max-w-5xl">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-extrabold text-gray-900 mb-2">
            Create <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Booking Venue</span>
          </h1>
          <p className="text-lg text-gray-600">Set up a new venue for table bookings</p>
        </div>
...
export default CreateBookingVenuePage;
